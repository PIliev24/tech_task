...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({required final List<Medication> medications})
  ...
  @override
  String toString() {
    return 'HomeState(medications: $medications)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({required final List<Medication> medications}) =
      _$HomeStateImpl;
